...
@pytest.mark.parametrize('script,expected', [
    ...
    ("if _p in customer.favorites and _p not in cart: pass", {'output': None, 'args': [{'values': [{'right': {'path': 'customer.favorites'}, 'method': 'contains', 'left': {'path': '_p'}}, {'right': {'path': '_p'}, 'method': 'excludes', 'left': {'path': 'cart'}}], 'expression': '{} and {}'}], 'method': 'if', 'parent': None, 'kwargs': None, 'linenum': '1'}),
