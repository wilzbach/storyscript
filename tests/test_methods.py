...
class Tests(unittest.TestCase):
    ...
    @data(("foreach product: pass", {'args': [{'path': 'product'}], 'output': None, 'linenum': '1', 'method': 'foreach', 'parent': None, 'kwargs': None}),
          ...
          ('when number of orders for "today" > 50: pass', {"output": None, "args": [{"values": {"0": {"path": "count", "limit": 1, "figure": "orders", "time": {"value": "today"} } }, "expression": "{0} > 50.0"} ], "method": "when", "parent": None, "kwargs": None , 'linenum': '1'}),
          ("push x into y", {'output': None, 'args': [{'path': 'x'}, {'path': 'y'}], 'method': 'push', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ...
          ('after "my-custom-event": pass', {'output': None, 'args': [{'value': 'my-custom-event'}], 'method': 'after', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ('with _customer: pass', {'output': None, 'args': [{'path': '_customer'}], 'method': 'with', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ("every 'monday at 5pm'", {'output': None, 'args': ['every', {'value': 'monday at 5pm'}], 'method': 'schedule', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ("wait 'jan 25th 5:45am': pass", {'output': None, 'args': [{'value': 'jan 25th 5:45am'}], 'method': 'wait', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ("weekly 'mondays at 5pm'", {'output': None, 'args': ["weekly", {'value': 'mondays at 5pm'}], 'method': 'schedule', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ("hourly '10am'", {'output': None, 'args': ["hourly", {'value': '10am'}], 'method': 'schedule', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ("daily '10am'", {'output': None, 'args': ["daily", {'value': '10am'}], 'method': 'schedule', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ("weekly '10am'", {'output': None, 'args': ["weekly", {'value': '10am'}], 'method': 'schedule', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ("monthly '10am'", {'output': None, 'args': ["monthly", {'value': '10am'}], 'method': 'schedule', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ("quarterly '10am'", {'output': None, 'args': ["quarterly", {'value': '10am'}], 'method': 'schedule', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ("yearly '10am'", {'output': None, 'args': ["yearly", {'value': '10am'}], 'method': 'schedule', 'parent': None, 'kwargs': None, 'linenum': '1'}),
          ...
          ("wait '5 minutes': pass", {'output': None, 'args': [{'value': '5 minutes'}], 'method': 'wait', 'parent': None, 'kwargs': None, 'linenum': '1'}),
